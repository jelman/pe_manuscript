...
```{r, include=F}
# Load data
allDat = read.csv("~/netshare/K/Projects/PracticeEffects/data/V1V2_CogData_TEDALLAdj.csv")
...
write.csv(results, '~/netshare/K/Projects/PracticeEffects/results/PracEffectValues_TEDALLAdj.csv')
```
